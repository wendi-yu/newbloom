...
import { getUsersByIds } from '@/util/user_apis';
...
const ListSelector = ({ docInfos }) => {
    ...
    const columns = [
        {
            ...
            dataIndex: "name",
            key: "name",
            render: (text) => (<div className="flex flex-row items-center space-x-2">
    ...
    return <Table dataSource={dataSource} columns={columns} onRow={navigateToDoc} />
}
